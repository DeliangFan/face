...
def best_match(known_face_encodings, face_encoding_to_check, tolerance):
...
for face in faces["faces"]:
    known_face_encodings.append(face["face_encoding"])
    ...
    if count > 5:
        ...
        if len(face_locations) > 0:
            ...
            for face_encoding in face_encodings:
                ...
                matches = best_match(known_face_encodings, face_encoding, 0.45)
                name = "Unknown"
